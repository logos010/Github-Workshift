...
class YumPermission extends YumActiveRecord {
	...
	public function rules() {
		return array(
			array('principal_id, subordinate_id, type, action', 'required'),
			...
			array('principal_id, subordinate_id, type, action, template, comment', 'safe'),
                        array('action_title_search', 'safe', 'on' => 'search'),
		);
	}
	...
	public function search() {
		...
		$criteria->compare('comment', $this->comment, true);
                ...
                $criteria->compare('Action.title', $this->action_title_search, true);
                
		return new CActiveDataProvider(get_class($this), array(
			'criteria'=>$criteria,
                        'sort' => array(
                            'attributes' => array(
                                'action_title_search' => array(
                                    'asc' => 'Action.title',
                                    'desc' => 'Action.title desc'
                                )
                            ),
                        ),
